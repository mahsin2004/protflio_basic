...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_sqoqggh', 'template_mz7t38l', form.current, 'HSIj4KPJmJ8-VahUq')
      .then(() => {
        form.current.reset();
        Swal.fire({
          icon: 'success',
  ...
  return (
    <div className="py-16 bg-white max-w-6xl mx-auto px-8" id="contact">
      <h1 className="text-4xl font-bold pb-8 text-[#495057] text-center lg:text-left">Get In Touch</h1>
